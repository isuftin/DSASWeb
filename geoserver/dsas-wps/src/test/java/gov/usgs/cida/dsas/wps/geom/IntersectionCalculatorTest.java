...
public class IntersectionCalculatorTest {
	...
	/**
	 * Test of execute method, of class IntersectionCalculator.
	 */
	@Test
	...
	public void testToLineSegments() {
		LineString lineString = gf.createLineString(new Coordinate[]{
			...
			new Coordinate(6, 7),
			new Coordinate(7, 8),});
		List<LineSegment> lineSegments = IntersectionCalculator.toLineSegments(lineString);
	...
	public void testFindIntervals_IntervalEqualToCoordSpacing_WithOrigin() {
		...
		lineSegments = IntersectionCalculator.findIntervals(lineString, true, 1);
	...
	public void testFindIntervals_IntervalEqualToCoordSpacing_WithoutOrigin() {
		...
		lineSegments = IntersectionCalculator.findIntervals(lineString, false, 1);
	...
	public void testFindIntervals_IntervalGreaterThanCoordSpacing_WithOrigin() {
		...
		lineSegments = IntersectionCalculator.findIntervals(lineString, true, 2.5);
	...
	public void testFindIntervals_IntervalGreaterThanCoordSpacing_WithoutOrigin() {
		...
		lineSegments = IntersectionCalculator.findIntervals(lineString, false, 2.5);
