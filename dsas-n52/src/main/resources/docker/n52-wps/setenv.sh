...
R_SERVE_HOST=${CCHRSERVE_PORT_6311_TCP_ADDR:-$R_SERVE_HOST}
R_SERVE_PORT=${CCHRSERVE_PORT_6311_TCP_PORT:-$R_SERVE_PORT}
R_SERVE_USER=${CCHRSERVE_ENV_USERNAME:-"rserve"}
R_SERVE_PASS=${CCHRSERVE_ENV_PASSWORD:-"rserve"}
R_SERVE_HOME=${CCHRSERVE_ENV_RSERVE_HOME:-""}
R_SERVE_SCRIPTDIR=${CCHRSERVE_ENV_SCRIPTDIR:-"${R_SERVE_HOME}/R/r_scripts"}
R_SERVE_RESOURCEDIR=${CCHRSERVE_ENV_RESOURCEDIR:-"${R_SERVE_HOME}/R/resources"}
R_SERVE_WORKDIR=${CCHRSERVE_WORKDIR:-"default"}
