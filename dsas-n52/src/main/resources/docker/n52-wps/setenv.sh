...
R_SERVE_HOST=${DSAS_RSERVE_PORT_6311_TCP_ADDR:-$R_SERVE_HOST}
R_SERVE_PORT=${DSAS_RSERVE_PORT_6311_TCP_PORT:-$R_SERVE_PORT}
R_SERVE_USER=${DSAS_RSERVE_ENV_USERNAME:-"rserve"}
R_SERVE_PASS=${DSAS_RSERVE_ENV_PASSWORD:-"rserve"}
R_SERVE_HOME=${DSAS_RSERVE_ENV_RSERVE_HOME:-""}
R_SERVE_SCRIPTDIR=${DSAS_RSERVE_ENV_SCRIPTDIR:-"${R_SERVE_HOME}/R/r_scripts"}
R_SERVE_RESOURCEDIR=${DSAS_RSERVE_ENV_RESOURCEDIR:-"${R_SERVE_HOME}/R/resources"}
R_SERVE_WORKDIR=${DSAS_RSERVE_WORKDIR:-"default"}
