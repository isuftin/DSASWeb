package gov.usgs.cida.dsas.rest.service;

/**
 * URI constants for the Service endpoint
 *
 * @author isuftin
 */
public class ServiceURI {
	...
	public static final String UI_ENDPOINT = "/ui";
	public static final String SHAPEFILE_SERVICE_ENDPOINT = SERVICE_ENDPOINT + "/shapefile";
	public static final String PDB_SHAPEFILE_SERVICE_ENDPOINT = SERVICE_ENDPOINT + "/shapefile/pdb";
